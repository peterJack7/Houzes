<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(App_Themes/img/bg-img/hero1.jpg);">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(App_Themes/img/bg-img/hero2.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(App_Themes/img/bg-img/hero3.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
 ...
 <!-- ##### Advance Search Area Start ##### -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 d-flex justify-content-between align-items-end">
                                    ...
                                    <div class="form-group mb-0">
                                        <button type="submit" onclick="" class="btn south-btn">Search</button>
                                    </div>
                                </div>
                            </div>
  ...
  <div class="container">
                    ...
                    <div class="col-md-3 col-sm-3">
                        ...
                        <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="property-thumb">
                                <img class="img-thumbnail" src="<%#Eval("Property_Picture") %>" style="height:250px; width:350px;" alt="">
                          ...
                          <div class="property-content">
                                ...
                                <div class="property-meta-data d-flex align-items-end justify-content-between">
                                    ...
                                    <asp:Button ID="Button1" CssClass="btn btn-danger" runat="server" Text="View Contact" OnClick="Button1_Click" />
                            </div>
                        </div>
    ...
    <section class="call-to-action-area bg-fixed bg-overlay-black" style="background-image: url(App_Themes/img/bg-img/cta.jpg)">
        <div class="container h-100">
                    ...
                    <div class="testimonials-slides owl-carousel wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <div class="single-testimonial-slide text-center">
                            ...
                            <div class="testimonial-author-info">
                                <img src="App_Themes/img/bg-img/feature6.jpg" alt="">
    ...
    <section class="south-editor-area d-flex align-items-center">
        ...
        <div class="editor-content-area">
            <!-- Section Heading -->
            <div class="section-heading wow fadeInUp" data-wow-delay="250ms">
                <img src="App_Themes/img/icons/prize.png" alt="">
                <h2>jeremy Scott</h2>
                <p>Realtor</p>
            </div>
            ...
            <div class="signature mt-50 wow fadeInUp" data-wow-delay="1000ms">
                <img src="App_Themes/img/core-img/signature.png" alt="">
            </div>
        </div>

        <!-- Editor Thumbnail -->
        <div class="editor-thumbnail">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/negni3BiiT4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
    </section>
    <!-- ##### Editor Area End ##### -->
